...
export default function Nav() {
    ...
    const mobileUIViews = {
        ...
        "account": session?.user?.id ? <Account /> : <AuthForm type={formType} />,
    ...
    return (
        ...
        <nav onClick={handleDropDown} className={`hidden  text-green-950 fixed z-50 bg-black bg-opacity-50  h-screen max-[900px]:flex flex-col ${openMobileNav ? "w-full" : "w-0"} transition-all duration-500 overflow-hidden`}>
